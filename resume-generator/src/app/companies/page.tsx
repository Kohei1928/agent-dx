      ...
      <div className="p-8">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/companies/hubspot"
              className="px-4 py-2.5 bg-orange-100 text-orange-700 hover:bg-orange-200 rounded-lg font-medium transition-colors flex items-center gap-2"
            >
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                <path d="M22.5 12c0-5.799-4.701-10.5-10.5-10.5S1.5 6.201 1.5 12s4.701 10.5 10.5 10.5S22.5 17.799 22.5 12z" />
              </svg>
              <span>HubSpot連携</span>
            </Link>
            <Link
              href="/companies/import"
              className="px-4 py-2.5 bg-green-100 text-green-700 hover:bg-green-200 rounded-lg font-medium transition-colors flex items-center gap-2"
            >
