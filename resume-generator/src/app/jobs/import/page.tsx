...
export default function JobImportPage() {
  ...
  const handleDownloadTemplate = () => {
    window.location.href = "/api/jobs/import";
  };
        ...
        <div className="card p-6 mb-6 bg-gradient-to-r from-purple-50 to-pink-50 border-purple-200">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="px-4 py-2 bg-white text-purple-600 hover:bg-purple-50 rounded-lg font-medium transition-colors border border-purple-200 flex items-center gap-2"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm text-amber-800">
              ...
              <ul className="list-disc list-inside space-y-1 text-amber-700">
                <li>企業名が存在しない場合は自動的に企業マスタに登録されます</li>
                <li>求人コードまたは「企業名＋求人タイトル」で既存求人を判定します</li>
                <li>必須項目：企業名、求人タイトル</li>
              </ul>
            </div>
          </div>
        </div>
